...
import 'package:shopzilla/components/cards/grid_card.dart';
import 'package:shopzilla/components/models/product.dart';
import 'package:shopzilla/components/other_widgets/slideshow.dart';
import 'package:shopzilla/screens/product_details.dart';
    ...
    for (var item in chipList) {
      choices.add(ChoiceChip(
        ...
        labelStyle: Theme.of(context).textTheme.bodySmall!.copyWith(
            fontWeight:
                selectedChoice == item ? FontWeight.w900 : FontWeight.w100,
